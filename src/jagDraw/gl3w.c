...
PFNGLBINDBUFFERARBPROC gl3wBindBufferARB;
PFNGLDELETEBUFFERSARBPROC gl3wDeleteBuffersARB;
PFNGLGENBUFFERSARBPROC gl3wGenBuffersARB;
PFNGLISBUFFERARBPROC gl3wIsBufferARB;
PFNGLBUFFERDATAARBPROC gl3wBufferDataARB;
PFNGLBUFFERSUBDATAARBPROC gl3wBufferSubDataARB;
PFNGLGETBUFFERSUBDATAARBPROC gl3wGetBufferSubDataARB;
PFNGLMAPBUFFERARBPROC gl3wMapBufferARB;
...
PFNGLCOPYIMAGESUBDATANVPROC gl3wCopyImageSubDataNV;
...
PFNGLDRAWTEXTURENVPROC gl3wDrawTextureNV;
PFNGLMAPCONTROLPOINTSNVPROC gl3wMapControlPointsNV;
PFNGLMAPPARAMETERIVNVPROC gl3wMapParameterivNV;
PFNGLMAPPARAMETERFVNVPROC gl3wMapParameterfvNV;
PFNGLGETMAPCONTROLPOINTSNVPROC gl3wGetMapControlPointsNV;
PFNGLGETMAPPARAMETERIVNVPROC gl3wGetMapParameterivNV;
PFNGLGETMAPPARAMETERFVNVPROC gl3wGetMapParameterfvNV;
PFNGLGETMAPATTRIBPARAMETERIVNVPROC gl3wGetMapAttribParameterivNV;
PFNGLGETMAPATTRIBPARAMETERFVNVPROC gl3wGetMapAttribParameterfvNV;
PFNGLEVALMAPSNVPROC gl3wEvalMapsNV;
PFNGLGETMULTISAMPLEFVNVPROC gl3wGetMultisamplefvNV;
PFNGLSAMPLEMASKINDEXEDNVPROC gl3wSampleMaskIndexedNV;
PFNGLTEXRENDERBUFFERNVPROC gl3wTexRenderbufferNV;
PFNGLDELETEFENCESNVPROC gl3wDeleteFencesNV;
PFNGLGENFENCESNVPROC gl3wGenFencesNV;
PFNGLISFENCENVPROC gl3wIsFenceNV;
PFNGLTESTFENCENVPROC gl3wTestFenceNV;
PFNGLGETFENCEIVNVPROC gl3wGetFenceivNV;
PFNGLFINISHFENCENVPROC gl3wFinishFenceNV;
PFNGLSETFENCENVPROC gl3wSetFenceNV;
PFNGLPROGRAMNAMEDPARAMETER4FNVPROC gl3wProgramNamedParameter4fNV;
PFNGLPROGRAMNAMEDPARAMETER4FVNVPROC gl3wProgramNamedParameter4fvNV;
PFNGLPROGRAMNAMEDPARAMETER4DNVPROC gl3wProgramNamedParameter4dNV;
PFNGLPROGRAMNAMEDPARAMETER4DVNVPROC gl3wProgramNamedParameter4dvNV;
PFNGLGETPROGRAMNAMEDPARAMETERFVNVPROC gl3wGetProgramNamedParameterfvNV;
PFNGLGETPROGRAMNAMEDPARAMETERDVNVPROC gl3wGetProgramNamedParameterdvNV;
PFNGLRENDERBUFFERSTORAGEMULTISAMPLECOVERAGENVPROC gl3wRenderbufferStorageMultisampleCoverageNV;
PFNGLPROGRAMVERTEXLIMITNVPROC gl3wProgramVertexLimitNV;
PFNGLFRAMEBUFFERTEXTUREEXTPROC gl3wFramebufferTextureEXT;
PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC gl3wFramebufferTextureLayerEXT;
PFNGLFRAMEBUFFERTEXTUREFACEEXTPROC gl3wFramebufferTextureFaceEXT;
PFNGLPROGRAMLOCALPARAMETERI4INVPROC gl3wProgramLocalParameterI4iNV;
PFNGLPROGRAMLOCALPARAMETERI4IVNVPROC gl3wProgramLocalParameterI4ivNV;
PFNGLPROGRAMLOCALPARAMETERSI4IVNVPROC gl3wProgramLocalParametersI4ivNV;
PFNGLPROGRAMLOCALPARAMETERI4UINVPROC gl3wProgramLocalParameterI4uiNV;
PFNGLPROGRAMLOCALPARAMETERI4UIVNVPROC gl3wProgramLocalParameterI4uivNV;
PFNGLPROGRAMLOCALPARAMETERSI4UIVNVPROC gl3wProgramLocalParametersI4uivNV;
PFNGLPROGRAMENVPARAMETERI4INVPROC gl3wProgramEnvParameterI4iNV;
PFNGLPROGRAMENVPARAMETERI4IVNVPROC gl3wProgramEnvParameterI4ivNV;
PFNGLPROGRAMENVPARAMETERSI4IVNVPROC gl3wProgramEnvParametersI4ivNV;
PFNGLPROGRAMENVPARAMETERI4UINVPROC gl3wProgramEnvParameterI4uiNV;
PFNGLPROGRAMENVPARAMETERI4UIVNVPROC gl3wProgramEnvParameterI4uivNV;
PFNGLPROGRAMENVPARAMETERSI4UIVNVPROC gl3wProgramEnvParametersI4uivNV;
PFNGLGETPROGRAMLOCALPARAMETERIIVNVPROC gl3wGetProgramLocalParameterIivNV;
PFNGLGETPROGRAMLOCALPARAMETERIUIVNVPROC gl3wGetProgramLocalParameterIuivNV;
PFNGLGETPROGRAMENVPARAMETERIIVNVPROC gl3wGetProgramEnvParameterIivNV;
PFNGLGETPROGRAMENVPARAMETERIUIVNVPROC gl3wGetProgramEnvParameterIuivNV;
PFNGLPROGRAMSUBROUTINEPARAMETERSUIVNVPROC gl3wProgramSubroutineParametersuivNV;
PFNGLGETPROGRAMSUBROUTINEPARAMETERUIVNVPROC gl3wGetProgramSubroutineParameteruivNV;
...
PFNGLVERTEX2HNVPROC gl3wVertex2hNV;
PFNGLVERTEX2HVNVPROC gl3wVertex2hvNV;
PFNGLVERTEX3HNVPROC gl3wVertex3hNV;
PFNGLVERTEX3HVNVPROC gl3wVertex3hvNV;
PFNGLVERTEX4HNVPROC gl3wVertex4hNV;
PFNGLVERTEX4HVNVPROC gl3wVertex4hvNV;
PFNGLNORMAL3HNVPROC gl3wNormal3hNV;
PFNGLNORMAL3HVNVPROC gl3wNormal3hvNV;
PFNGLCOLOR3HNVPROC gl3wColor3hNV;
PFNGLCOLOR3HVNVPROC gl3wColor3hvNV;
PFNGLCOLOR4HNVPROC gl3wColor4hNV;
PFNGLCOLOR4HVNVPROC gl3wColor4hvNV;
PFNGLTEXCOORD1HNVPROC gl3wTexCoord1hNV;
PFNGLTEXCOORD1HVNVPROC gl3wTexCoord1hvNV;
PFNGLTEXCOORD2HNVPROC gl3wTexCoord2hNV;
PFNGLTEXCOORD2HVNVPROC gl3wTexCoord2hvNV;
PFNGLTEXCOORD3HNVPROC gl3wTexCoord3hNV;
PFNGLTEXCOORD3HVNVPROC gl3wTexCoord3hvNV;
PFNGLTEXCOORD4HNVPROC gl3wTexCoord4hNV;
PFNGLTEXCOORD4HVNVPROC gl3wTexCoord4hvNV;
PFNGLMULTITEXCOORD1HNVPROC gl3wMultiTexCoord1hNV;
PFNGLMULTITEXCOORD1HVNVPROC gl3wMultiTexCoord1hvNV;
PFNGLMULTITEXCOORD2HNVPROC gl3wMultiTexCoord2hNV;
PFNGLMULTITEXCOORD2HVNVPROC gl3wMultiTexCoord2hvNV;
PFNGLMULTITEXCOORD3HNVPROC gl3wMultiTexCoord3hNV;
PFNGLMULTITEXCOORD3HVNVPROC gl3wMultiTexCoord3hvNV;
PFNGLMULTITEXCOORD4HNVPROC gl3wMultiTexCoord4hNV;
PFNGLMULTITEXCOORD4HVNVPROC gl3wMultiTexCoord4hvNV;
PFNGLFOGCOORDHNVPROC gl3wFogCoordhNV;
PFNGLFOGCOORDHVNVPROC gl3wFogCoordhvNV;
PFNGLSECONDARYCOLOR3HNVPROC gl3wSecondaryColor3hNV;
PFNGLSECONDARYCOLOR3HVNVPROC gl3wSecondaryColor3hvNV;
PFNGLVERTEXWEIGHTHNVPROC gl3wVertexWeighthNV;
PFNGLVERTEXWEIGHTHVNVPROC gl3wVertexWeighthvNV;
PFNGLVERTEXATTRIB1HNVPROC gl3wVertexAttrib1hNV;
PFNGLVERTEXATTRIB1HVNVPROC gl3wVertexAttrib1hvNV;
PFNGLVERTEXATTRIB2HNVPROC gl3wVertexAttrib2hNV;
PFNGLVERTEXATTRIB2HVNVPROC gl3wVertexAttrib2hvNV;
PFNGLVERTEXATTRIB3HNVPROC gl3wVertexAttrib3hNV;
PFNGLVERTEXATTRIB3HVNVPROC gl3wVertexAttrib3hvNV;
PFNGLVERTEXATTRIB4HNVPROC gl3wVertexAttrib4hNV;
PFNGLVERTEXATTRIB4HVNVPROC gl3wVertexAttrib4hvNV;
PFNGLVERTEXATTRIBS1HVNVPROC gl3wVertexAttribs1hvNV;
PFNGLVERTEXATTRIBS2HVNVPROC gl3wVertexAttribs2hvNV;
PFNGLVERTEXATTRIBS3HVNVPROC gl3wVertexAttribs3hvNV;
PFNGLVERTEXATTRIBS4HVNVPROC gl3wVertexAttribs4hvNV;
PFNGLGENOCCLUSIONQUERIESNVPROC gl3wGenOcclusionQueriesNV;
PFNGLDELETEOCCLUSIONQUERIESNVPROC gl3wDeleteOcclusionQueriesNV;
PFNGLISOCCLUSIONQUERYNVPROC gl3wIsOcclusionQueryNV;
PFNGLBEGINOCCLUSIONQUERYNVPROC gl3wBeginOcclusionQueryNV;
PFNGLENDOCCLUSIONQUERYNVPROC gl3wEndOcclusionQueryNV;
PFNGLGETOCCLUSIONQUERYIVNVPROC gl3wGetOcclusionQueryivNV;
PFNGLGETOCCLUSIONQUERYUIVNVPROC gl3wGetOcclusionQueryuivNV;
PFNGLPROGRAMBUFFERPARAMETERSFVNVPROC gl3wProgramBufferParametersfvNV;
PFNGLPROGRAMBUFFERPARAMETERSIIVNVPROC gl3wProgramBufferParametersIivNV;
PFNGLPROGRAMBUFFERPARAMETERSIUIVNVPROC gl3wProgramBufferParametersIuivNV;
...
PFNGLPATHCOLORGENNVPROC gl3wPathColorGenNV;
PFNGLPATHTEXGENNVPROC gl3wPathTexGenNV;
PFNGLPATHFOGGENNVPROC gl3wPathFogGenNV;
...
PFNGLGETPATHCOLORGENIVNVPROC gl3wGetPathColorGenivNV;
PFNGLGETPATHCOLORGENFVNVPROC gl3wGetPathColorGenfvNV;
PFNGLGETPATHTEXGENIVNVPROC gl3wGetPathTexGenivNV;
PFNGLGETPATHTEXGENFVNVPROC gl3wGetPathTexGenfvNV;
...
PFNGLPIXELDATARANGENVPROC gl3wPixelDataRangeNV;
PFNGLFLUSHPIXELDATARANGENVPROC gl3wFlushPixelDataRangeNV;
PFNGLPOINTPARAMETERINVPROC gl3wPointParameteriNV;
PFNGLPOINTPARAMETERIVNVPROC gl3wPointParameterivNV;
PFNGLPRESENTFRAMEKEYEDNVPROC gl3wPresentFrameKeyedNV;
PFNGLPRESENTFRAMEDUALFILLNVPROC gl3wPresentFrameDualFillNV;
PFNGLGETVIDEOIVNVPROC gl3wGetVideoivNV;
PFNGLGETVIDEOUIVNVPROC gl3wGetVideouivNV;
PFNGLGETVIDEOI64VNVPROC gl3wGetVideoi64vNV;
PFNGLGETVIDEOUI64VNVPROC gl3wGetVideoui64vNV;
PFNGLPRIMITIVERESTARTNVPROC gl3wPrimitiveRestartNV;
PFNGLPRIMITIVERESTARTINDEXNVPROC gl3wPrimitiveRestartIndexNV;
PFNGLCOMBINERPARAMETERFVNVPROC gl3wCombinerParameterfvNV;
PFNGLCOMBINERPARAMETERFNVPROC gl3wCombinerParameterfNV;
PFNGLCOMBINERPARAMETERIVNVPROC gl3wCombinerParameterivNV;
PFNGLCOMBINERPARAMETERINVPROC gl3wCombinerParameteriNV;
PFNGLCOMBINERINPUTNVPROC gl3wCombinerInputNV;
PFNGLCOMBINEROUTPUTNVPROC gl3wCombinerOutputNV;
PFNGLFINALCOMBINERINPUTNVPROC gl3wFinalCombinerInputNV;
PFNGLGETCOMBINERINPUTPARAMETERFVNVPROC gl3wGetCombinerInputParameterfvNV;
PFNGLGETCOMBINERINPUTPARAMETERIVNVPROC gl3wGetCombinerInputParameterivNV;
PFNGLGETCOMBINEROUTPUTPARAMETERFVNVPROC gl3wGetCombinerOutputParameterfvNV;
PFNGLGETCOMBINEROUTPUTPARAMETERIVNVPROC gl3wGetCombinerOutputParameterivNV;
PFNGLGETFINALCOMBINERINPUTPARAMETERFVNVPROC gl3wGetFinalCombinerInputParameterfvNV;
PFNGLGETFINALCOMBINERINPUTPARAMETERIVNVPROC gl3wGetFinalCombinerInputParameterivNV;
PFNGLCOMBINERSTAGEPARAMETERFVNVPROC gl3wCombinerStageParameterfvNV;
PFNGLGETCOMBINERSTAGEPARAMETERFVNVPROC gl3wGetCombinerStageParameterfvNV;
...
PFNGLTEXIMAGE2DMULTISAMPLECOVERAGENVPROC gl3wTexImage2DMultisampleCoverageNV;
PFNGLTEXIMAGE3DMULTISAMPLECOVERAGENVPROC gl3wTexImage3DMultisampleCoverageNV;
PFNGLTEXTUREIMAGE2DMULTISAMPLENVPROC gl3wTextureImage2DMultisampleNV;
PFNGLTEXTUREIMAGE3DMULTISAMPLENVPROC gl3wTextureImage3DMultisampleNV;
PFNGLTEXTUREIMAGE2DMULTISAMPLECOVERAGENVPROC gl3wTextureImage2DMultisampleCoverageNV;
PFNGLTEXTUREIMAGE3DMULTISAMPLECOVERAGENVPROC gl3wTextureImage3DMultisampleCoverageNV;
PFNGLBEGINTRANSFORMFEEDBACKNVPROC gl3wBeginTransformFeedbackNV;
PFNGLENDTRANSFORMFEEDBACKNVPROC gl3wEndTransformFeedbackNV;
PFNGLTRANSFORMFEEDBACKATTRIBSNVPROC gl3wTransformFeedbackAttribsNV;
PFNGLBINDBUFFERRANGENVPROC gl3wBindBufferRangeNV;
PFNGLBINDBUFFEROFFSETNVPROC gl3wBindBufferOffsetNV;
PFNGLBINDBUFFERBASENVPROC gl3wBindBufferBaseNV;
PFNGLTRANSFORMFEEDBACKVARYINGSNVPROC gl3wTransformFeedbackVaryingsNV;
PFNGLACTIVEVARYINGNVPROC gl3wActiveVaryingNV;
PFNGLGETVARYINGLOCATIONNVPROC gl3wGetVaryingLocationNV;
PFNGLGETACTIVEVARYINGNVPROC gl3wGetActiveVaryingNV;
PFNGLGETTRANSFORMFEEDBACKVARYINGNVPROC gl3wGetTransformFeedbackVaryingNV;
PFNGLTRANSFORMFEEDBACKSTREAMATTRIBSNVPROC gl3wTransformFeedbackStreamAttribsNV;
PFNGLBINDTRANSFORMFEEDBACKNVPROC gl3wBindTransformFeedbackNV;
PFNGLDELETETRANSFORMFEEDBACKSNVPROC gl3wDeleteTransformFeedbacksNV;
PFNGLGENTRANSFORMFEEDBACKSNVPROC gl3wGenTransformFeedbacksNV;
PFNGLISTRANSFORMFEEDBACKNVPROC gl3wIsTransformFeedbackNV;
PFNGLPAUSETRANSFORMFEEDBACKNVPROC gl3wPauseTransformFeedbackNV;
PFNGLRESUMETRANSFORMFEEDBACKNVPROC gl3wResumeTransformFeedbackNV;
PFNGLDRAWTRANSFORMFEEDBACKNVPROC gl3wDrawTransformFeedbackNV;
PFNGLVDPAUINITNVPROC gl3wVDPAUInitNV;
PFNGLVDPAUFININVPROC gl3wVDPAUFiniNV;
PFNGLVDPAUREGISTERVIDEOSURFACENVPROC gl3wVDPAURegisterVideoSurfaceNV;
PFNGLVDPAUREGISTEROUTPUTSURFACENVPROC gl3wVDPAURegisterOutputSurfaceNV;
PFNGLVDPAUISSURFACENVPROC gl3wVDPAUIsSurfaceNV;
PFNGLVDPAUUNREGISTERSURFACENVPROC gl3wVDPAUUnregisterSurfaceNV;
PFNGLVDPAUGETSURFACEIVNVPROC gl3wVDPAUGetSurfaceivNV;
PFNGLVDPAUSURFACEACCESSNVPROC gl3wVDPAUSurfaceAccessNV;
PFNGLVDPAUMAPSURFACESNVPROC gl3wVDPAUMapSurfacesNV;
PFNGLVDPAUUNMAPSURFACESNVPROC gl3wVDPAUUnmapSurfacesNV;
PFNGLFLUSHVERTEXARRAYRANGENVPROC gl3wFlushVertexArrayRangeNV;
PFNGLVERTEXARRAYRANGENVPROC gl3wVertexArrayRangeNV;
...
PFNGLAREPROGRAMSRESIDENTNVPROC gl3wAreProgramsResidentNV;
PFNGLBINDPROGRAMNVPROC gl3wBindProgramNV;
PFNGLDELETEPROGRAMSNVPROC gl3wDeleteProgramsNV;
PFNGLEXECUTEPROGRAMNVPROC gl3wExecuteProgramNV;
PFNGLGENPROGRAMSNVPROC gl3wGenProgramsNV;
PFNGLGETPROGRAMPARAMETERDVNVPROC gl3wGetProgramParameterdvNV;
PFNGLGETPROGRAMPARAMETERFVNVPROC gl3wGetProgramParameterfvNV;
PFNGLGETPROGRAMIVNVPROC gl3wGetProgramivNV;
PFNGLGETPROGRAMSTRINGNVPROC gl3wGetProgramStringNV;
PFNGLGETTRACKMATRIXIVNVPROC gl3wGetTrackMatrixivNV;
PFNGLGETVERTEXATTRIBDVNVPROC gl3wGetVertexAttribdvNV;
PFNGLGETVERTEXATTRIBFVNVPROC gl3wGetVertexAttribfvNV;
PFNGLGETVERTEXATTRIBIVNVPROC gl3wGetVertexAttribivNV;
PFNGLGETVERTEXATTRIBPOINTERVNVPROC gl3wGetVertexAttribPointervNV;
PFNGLISPROGRAMNVPROC gl3wIsProgramNV;
PFNGLLOADPROGRAMNVPROC gl3wLoadProgramNV;
PFNGLPROGRAMPARAMETER4DNVPROC gl3wProgramParameter4dNV;
PFNGLPROGRAMPARAMETER4DVNVPROC gl3wProgramParameter4dvNV;
PFNGLPROGRAMPARAMETER4FNVPROC gl3wProgramParameter4fNV;
PFNGLPROGRAMPARAMETER4FVNVPROC gl3wProgramParameter4fvNV;
PFNGLPROGRAMPARAMETERS4DVNVPROC gl3wProgramParameters4dvNV;
PFNGLPROGRAMPARAMETERS4FVNVPROC gl3wProgramParameters4fvNV;
PFNGLREQUESTRESIDENTPROGRAMSNVPROC gl3wRequestResidentProgramsNV;
PFNGLTRACKMATRIXNVPROC gl3wTrackMatrixNV;
PFNGLVERTEXATTRIBPOINTERNVPROC gl3wVertexAttribPointerNV;
PFNGLVERTEXATTRIB1DNVPROC gl3wVertexAttrib1dNV;
PFNGLVERTEXATTRIB1DVNVPROC gl3wVertexAttrib1dvNV;
PFNGLVERTEXATTRIB1FNVPROC gl3wVertexAttrib1fNV;
PFNGLVERTEXATTRIB1FVNVPROC gl3wVertexAttrib1fvNV;
PFNGLVERTEXATTRIB1SNVPROC gl3wVertexAttrib1sNV;
PFNGLVERTEXATTRIB1SVNVPROC gl3wVertexAttrib1svNV;
PFNGLVERTEXATTRIB2DNVPROC gl3wVertexAttrib2dNV;
PFNGLVERTEXATTRIB2DVNVPROC gl3wVertexAttrib2dvNV;
PFNGLVERTEXATTRIB2FNVPROC gl3wVertexAttrib2fNV;
PFNGLVERTEXATTRIB2FVNVPROC gl3wVertexAttrib2fvNV;
PFNGLVERTEXATTRIB2SNVPROC gl3wVertexAttrib2sNV;
PFNGLVERTEXATTRIB2SVNVPROC gl3wVertexAttrib2svNV;
PFNGLVERTEXATTRIB3DNVPROC gl3wVertexAttrib3dNV;
PFNGLVERTEXATTRIB3DVNVPROC gl3wVertexAttrib3dvNV;
PFNGLVERTEXATTRIB3FNVPROC gl3wVertexAttrib3fNV;
PFNGLVERTEXATTRIB3FVNVPROC gl3wVertexAttrib3fvNV;
PFNGLVERTEXATTRIB3SNVPROC gl3wVertexAttrib3sNV;
PFNGLVERTEXATTRIB3SVNVPROC gl3wVertexAttrib3svNV;
PFNGLVERTEXATTRIB4DNVPROC gl3wVertexAttrib4dNV;
PFNGLVERTEXATTRIB4DVNVPROC gl3wVertexAttrib4dvNV;
PFNGLVERTEXATTRIB4FNVPROC gl3wVertexAttrib4fNV;
PFNGLVERTEXATTRIB4FVNVPROC gl3wVertexAttrib4fvNV;
PFNGLVERTEXATTRIB4SNVPROC gl3wVertexAttrib4sNV;
PFNGLVERTEXATTRIB4SVNVPROC gl3wVertexAttrib4svNV;
PFNGLVERTEXATTRIB4UBNVPROC gl3wVertexAttrib4ubNV;
PFNGLVERTEXATTRIB4UBVNVPROC gl3wVertexAttrib4ubvNV;
PFNGLVERTEXATTRIBS1DVNVPROC gl3wVertexAttribs1dvNV;
PFNGLVERTEXATTRIBS1FVNVPROC gl3wVertexAttribs1fvNV;
PFNGLVERTEXATTRIBS1SVNVPROC gl3wVertexAttribs1svNV;
PFNGLVERTEXATTRIBS2DVNVPROC gl3wVertexAttribs2dvNV;
PFNGLVERTEXATTRIBS2FVNVPROC gl3wVertexAttribs2fvNV;
PFNGLVERTEXATTRIBS2SVNVPROC gl3wVertexAttribs2svNV;
PFNGLVERTEXATTRIBS3DVNVPROC gl3wVertexAttribs3dvNV;
PFNGLVERTEXATTRIBS3FVNVPROC gl3wVertexAttribs3fvNV;
PFNGLVERTEXATTRIBS3SVNVPROC gl3wVertexAttribs3svNV;
PFNGLVERTEXATTRIBS4DVNVPROC gl3wVertexAttribs4dvNV;
PFNGLVERTEXATTRIBS4FVNVPROC gl3wVertexAttribs4fvNV;
PFNGLVERTEXATTRIBS4SVNVPROC gl3wVertexAttribs4svNV;
PFNGLVERTEXATTRIBS4UBVNVPROC gl3wVertexAttribs4ubvNV;
PFNGLVERTEXATTRIBI1IEXTPROC gl3wVertexAttribI1iEXT;
PFNGLVERTEXATTRIBI2IEXTPROC gl3wVertexAttribI2iEXT;
PFNGLVERTEXATTRIBI3IEXTPROC gl3wVertexAttribI3iEXT;
PFNGLVERTEXATTRIBI4IEXTPROC gl3wVertexAttribI4iEXT;
PFNGLVERTEXATTRIBI1UIEXTPROC gl3wVertexAttribI1uiEXT;
PFNGLVERTEXATTRIBI2UIEXTPROC gl3wVertexAttribI2uiEXT;
PFNGLVERTEXATTRIBI3UIEXTPROC gl3wVertexAttribI3uiEXT;
PFNGLVERTEXATTRIBI4UIEXTPROC gl3wVertexAttribI4uiEXT;
PFNGLVERTEXATTRIBI1IVEXTPROC gl3wVertexAttribI1ivEXT;
PFNGLVERTEXATTRIBI2IVEXTPROC gl3wVertexAttribI2ivEXT;
PFNGLVERTEXATTRIBI3IVEXTPROC gl3wVertexAttribI3ivEXT;
PFNGLVERTEXATTRIBI4IVEXTPROC gl3wVertexAttribI4ivEXT;
PFNGLVERTEXATTRIBI1UIVEXTPROC gl3wVertexAttribI1uivEXT;
PFNGLVERTEXATTRIBI2UIVEXTPROC gl3wVertexAttribI2uivEXT;
PFNGLVERTEXATTRIBI3UIVEXTPROC gl3wVertexAttribI3uivEXT;
PFNGLVERTEXATTRIBI4UIVEXTPROC gl3wVertexAttribI4uivEXT;
PFNGLVERTEXATTRIBI4BVEXTPROC gl3wVertexAttribI4bvEXT;
PFNGLVERTEXATTRIBI4SVEXTPROC gl3wVertexAttribI4svEXT;
PFNGLVERTEXATTRIBI4UBVEXTPROC gl3wVertexAttribI4ubvEXT;
PFNGLVERTEXATTRIBI4USVEXTPROC gl3wVertexAttribI4usvEXT;
PFNGLVERTEXATTRIBIPOINTEREXTPROC gl3wVertexAttribIPointerEXT;
PFNGLGETVERTEXATTRIBIIVEXTPROC gl3wGetVertexAttribIivEXT;
PFNGLGETVERTEXATTRIBIUIVEXTPROC gl3wGetVertexAttribIuivEXT;
PFNGLBEGINVIDEOCAPTURENVPROC gl3wBeginVideoCaptureNV;
PFNGLBINDVIDEOCAPTURESTREAMBUFFERNVPROC gl3wBindVideoCaptureStreamBufferNV;
PFNGLBINDVIDEOCAPTURESTREAMTEXTURENVPROC gl3wBindVideoCaptureStreamTextureNV;
PFNGLENDVIDEOCAPTURENVPROC gl3wEndVideoCaptureNV;
PFNGLGETVIDEOCAPTUREIVNVPROC gl3wGetVideoCaptureivNV;
PFNGLGETVIDEOCAPTURESTREAMIVNVPROC gl3wGetVideoCaptureStreamivNV;
PFNGLGETVIDEOCAPTURESTREAMFVNVPROC gl3wGetVideoCaptureStreamfvNV;
PFNGLGETVIDEOCAPTURESTREAMDVNVPROC gl3wGetVideoCaptureStreamdvNV;
PFNGLVIDEOCAPTURENVPROC gl3wVideoCaptureNV;
PFNGLVIDEOCAPTURESTREAMPARAMETERIVNVPROC gl3wVideoCaptureStreamParameterivNV;
PFNGLVIDEOCAPTURESTREAMPARAMETERFVNVPROC gl3wVideoCaptureStreamParameterfvNV;
PFNGLVIDEOCAPTURESTREAMPARAMETERDVNVPROC gl3wVideoCaptureStreamParameterdvNV;
...
static void load_procs(void)
{
	...
	gl3wBindBufferARB = (PFNGLBINDBUFFERARBPROC) get_proc("glBindBufferARB");
	gl3wDeleteBuffersARB = (PFNGLDELETEBUFFERSARBPROC) get_proc("glDeleteBuffersARB");
	gl3wGenBuffersARB = (PFNGLGENBUFFERSARBPROC) get_proc("glGenBuffersARB");
	gl3wIsBufferARB = (PFNGLISBUFFERARBPROC) get_proc("glIsBufferARB");
	gl3wBufferDataARB = (PFNGLBUFFERDATAARBPROC) get_proc("glBufferDataARB");
	gl3wBufferSubDataARB = (PFNGLBUFFERSUBDATAARBPROC) get_proc("glBufferSubDataARB");
	gl3wGetBufferSubDataARB = (PFNGLGETBUFFERSUBDATAARBPROC) get_proc("glGetBufferSubDataARB");
	gl3wMapBufferARB = (PFNGLMAPBUFFERARBPROC) get_proc("glMapBufferARB");
	...
	gl3wCopyImageSubDataNV = (PFNGLCOPYIMAGESUBDATANVPROC) get_proc("glCopyImageSubDataNV");
	gl3wDepthRangedNV = (PFNGLDEPTHRANGEDNVPROC) get_proc("glDepthRangedNV");
	gl3wClearDepthdNV = (PFNGLCLEARDEPTHDNVPROC) get_proc("glClearDepthdNV");
	gl3wDepthBoundsdNV = (PFNGLDEPTHBOUNDSDNVPROC) get_proc("glDepthBoundsdNV");
	gl3wDrawTextureNV = (PFNGLDRAWTEXTURENVPROC) get_proc("glDrawTextureNV");
	gl3wMapControlPointsNV = (PFNGLMAPCONTROLPOINTSNVPROC) get_proc("glMapControlPointsNV");
	gl3wMapParameterivNV = (PFNGLMAPPARAMETERIVNVPROC) get_proc("glMapParameterivNV");
	gl3wMapParameterfvNV = (PFNGLMAPPARAMETERFVNVPROC) get_proc("glMapParameterfvNV");
	gl3wGetMapControlPointsNV = (PFNGLGETMAPCONTROLPOINTSNVPROC) get_proc("glGetMapControlPointsNV");
	gl3wGetMapParameterivNV = (PFNGLGETMAPPARAMETERIVNVPROC) get_proc("glGetMapParameterivNV");
	gl3wGetMapParameterfvNV = (PFNGLGETMAPPARAMETERFVNVPROC) get_proc("glGetMapParameterfvNV");
	gl3wGetMapAttribParameterivNV = (PFNGLGETMAPATTRIBPARAMETERIVNVPROC) get_proc("glGetMapAttribParameterivNV");
	gl3wGetMapAttribParameterfvNV = (PFNGLGETMAPATTRIBPARAMETERFVNVPROC) get_proc("glGetMapAttribParameterfvNV");
	gl3wEvalMapsNV = (PFNGLEVALMAPSNVPROC) get_proc("glEvalMapsNV");
	gl3wGetMultisamplefvNV = (PFNGLGETMULTISAMPLEFVNVPROC) get_proc("glGetMultisamplefvNV");
	gl3wSampleMaskIndexedNV = (PFNGLSAMPLEMASKINDEXEDNVPROC) get_proc("glSampleMaskIndexedNV");
	gl3wTexRenderbufferNV = (PFNGLTEXRENDERBUFFERNVPROC) get_proc("glTexRenderbufferNV");
	gl3wDeleteFencesNV = (PFNGLDELETEFENCESNVPROC) get_proc("glDeleteFencesNV");
	gl3wGenFencesNV = (PFNGLGENFENCESNVPROC) get_proc("glGenFencesNV");
	gl3wIsFenceNV = (PFNGLISFENCENVPROC) get_proc("glIsFenceNV");
	gl3wTestFenceNV = (PFNGLTESTFENCENVPROC) get_proc("glTestFenceNV");
	gl3wGetFenceivNV = (PFNGLGETFENCEIVNVPROC) get_proc("glGetFenceivNV");
	gl3wFinishFenceNV = (PFNGLFINISHFENCENVPROC) get_proc("glFinishFenceNV");
	gl3wSetFenceNV = (PFNGLSETFENCENVPROC) get_proc("glSetFenceNV");
	gl3wProgramNamedParameter4fNV = (PFNGLPROGRAMNAMEDPARAMETER4FNVPROC) get_proc("glProgramNamedParameter4fNV");
	gl3wProgramNamedParameter4fvNV = (PFNGLPROGRAMNAMEDPARAMETER4FVNVPROC) get_proc("glProgramNamedParameter4fvNV");
	gl3wProgramNamedParameter4dNV = (PFNGLPROGRAMNAMEDPARAMETER4DNVPROC) get_proc("glProgramNamedParameter4dNV");
	gl3wProgramNamedParameter4dvNV = (PFNGLPROGRAMNAMEDPARAMETER4DVNVPROC) get_proc("glProgramNamedParameter4dvNV");
	gl3wGetProgramNamedParameterfvNV = (PFNGLGETPROGRAMNAMEDPARAMETERFVNVPROC) get_proc("glGetProgramNamedParameterfvNV");
	gl3wGetProgramNamedParameterdvNV = (PFNGLGETPROGRAMNAMEDPARAMETERDVNVPROC) get_proc("glGetProgramNamedParameterdvNV");
	...
	gl3wProgramVertexLimitNV = (PFNGLPROGRAMVERTEXLIMITNVPROC) get_proc("glProgramVertexLimitNV");
	gl3wFramebufferTextureEXT = (PFNGLFRAMEBUFFERTEXTUREEXTPROC) get_proc("glFramebufferTextureEXT");
	gl3wFramebufferTextureLayerEXT = (PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC) get_proc("glFramebufferTextureLayerEXT");
	gl3wFramebufferTextureFaceEXT = (PFNGLFRAMEBUFFERTEXTUREFACEEXTPROC) get_proc("glFramebufferTextureFaceEXT");
	gl3wProgramLocalParameterI4iNV = (PFNGLPROGRAMLOCALPARAMETERI4INVPROC) get_proc("glProgramLocalParameterI4iNV");
	gl3wProgramLocalParameterI4ivNV = (PFNGLPROGRAMLOCALPARAMETERI4IVNVPROC) get_proc("glProgramLocalParameterI4ivNV");
	gl3wProgramLocalParametersI4ivNV = (PFNGLPROGRAMLOCALPARAMETERSI4IVNVPROC) get_proc("glProgramLocalParametersI4ivNV");
	gl3wProgramLocalParameterI4uiNV = (PFNGLPROGRAMLOCALPARAMETERI4UINVPROC) get_proc("glProgramLocalParameterI4uiNV");
	gl3wProgramLocalParameterI4uivNV = (PFNGLPROGRAMLOCALPARAMETERI4UIVNVPROC) get_proc("glProgramLocalParameterI4uivNV");
	gl3wProgramLocalParametersI4uivNV = (PFNGLPROGRAMLOCALPARAMETERSI4UIVNVPROC) get_proc("glProgramLocalParametersI4uivNV");
	gl3wProgramEnvParameterI4iNV = (PFNGLPROGRAMENVPARAMETERI4INVPROC) get_proc("glProgramEnvParameterI4iNV");
	gl3wProgramEnvParameterI4ivNV = (PFNGLPROGRAMENVPARAMETERI4IVNVPROC) get_proc("glProgramEnvParameterI4ivNV");
	gl3wProgramEnvParametersI4ivNV = (PFNGLPROGRAMENVPARAMETERSI4IVNVPROC) get_proc("glProgramEnvParametersI4ivNV");
	gl3wProgramEnvParameterI4uiNV = (PFNGLPROGRAMENVPARAMETERI4UINVPROC) get_proc("glProgramEnvParameterI4uiNV");
	gl3wProgramEnvParameterI4uivNV = (PFNGLPROGRAMENVPARAMETERI4UIVNVPROC) get_proc("glProgramEnvParameterI4uivNV");
	gl3wProgramEnvParametersI4uivNV = (PFNGLPROGRAMENVPARAMETERSI4UIVNVPROC) get_proc("glProgramEnvParametersI4uivNV");
	gl3wGetProgramLocalParameterIivNV = (PFNGLGETPROGRAMLOCALPARAMETERIIVNVPROC) get_proc("glGetProgramLocalParameterIivNV");
	gl3wGetProgramLocalParameterIuivNV = (PFNGLGETPROGRAMLOCALPARAMETERIUIVNVPROC) get_proc("glGetProgramLocalParameterIuivNV");
	gl3wGetProgramEnvParameterIivNV = (PFNGLGETPROGRAMENVPARAMETERIIVNVPROC) get_proc("glGetProgramEnvParameterIivNV");
	gl3wGetProgramEnvParameterIuivNV = (PFNGLGETPROGRAMENVPARAMETERIUIVNVPROC) get_proc("glGetProgramEnvParameterIuivNV");
	gl3wProgramSubroutineParametersuivNV = (PFNGLPROGRAMSUBROUTINEPARAMETERSUIVNVPROC) get_proc("glProgramSubroutineParametersuivNV");
	gl3wGetProgramSubroutineParameteruivNV = (PFNGLGETPROGRAMSUBROUTINEPARAMETERUIVNVPROC) get_proc("glGetProgramSubroutineParameteruivNV");
	...
	gl3wVertex2hNV = (PFNGLVERTEX2HNVPROC) get_proc("glVertex2hNV");
	gl3wVertex2hvNV = (PFNGLVERTEX2HVNVPROC) get_proc("glVertex2hvNV");
	gl3wVertex3hNV = (PFNGLVERTEX3HNVPROC) get_proc("glVertex3hNV");
	gl3wVertex3hvNV = (PFNGLVERTEX3HVNVPROC) get_proc("glVertex3hvNV");
	gl3wVertex4hNV = (PFNGLVERTEX4HNVPROC) get_proc("glVertex4hNV");
	gl3wVertex4hvNV = (PFNGLVERTEX4HVNVPROC) get_proc("glVertex4hvNV");
	gl3wNormal3hNV = (PFNGLNORMAL3HNVPROC) get_proc("glNormal3hNV");
	gl3wNormal3hvNV = (PFNGLNORMAL3HVNVPROC) get_proc("glNormal3hvNV");
	gl3wColor3hNV = (PFNGLCOLOR3HNVPROC) get_proc("glColor3hNV");
	gl3wColor3hvNV = (PFNGLCOLOR3HVNVPROC) get_proc("glColor3hvNV");
	gl3wColor4hNV = (PFNGLCOLOR4HNVPROC) get_proc("glColor4hNV");
	gl3wColor4hvNV = (PFNGLCOLOR4HVNVPROC) get_proc("glColor4hvNV");
	gl3wTexCoord1hNV = (PFNGLTEXCOORD1HNVPROC) get_proc("glTexCoord1hNV");
	gl3wTexCoord1hvNV = (PFNGLTEXCOORD1HVNVPROC) get_proc("glTexCoord1hvNV");
	gl3wTexCoord2hNV = (PFNGLTEXCOORD2HNVPROC) get_proc("glTexCoord2hNV");
	gl3wTexCoord2hvNV = (PFNGLTEXCOORD2HVNVPROC) get_proc("glTexCoord2hvNV");
	gl3wTexCoord3hNV = (PFNGLTEXCOORD3HNVPROC) get_proc("glTexCoord3hNV");
	gl3wTexCoord3hvNV = (PFNGLTEXCOORD3HVNVPROC) get_proc("glTexCoord3hvNV");
	gl3wTexCoord4hNV = (PFNGLTEXCOORD4HNVPROC) get_proc("glTexCoord4hNV");
	gl3wTexCoord4hvNV = (PFNGLTEXCOORD4HVNVPROC) get_proc("glTexCoord4hvNV");
	gl3wMultiTexCoord1hNV = (PFNGLMULTITEXCOORD1HNVPROC) get_proc("glMultiTexCoord1hNV");
	gl3wMultiTexCoord1hvNV = (PFNGLMULTITEXCOORD1HVNVPROC) get_proc("glMultiTexCoord1hvNV");
	gl3wMultiTexCoord2hNV = (PFNGLMULTITEXCOORD2HNVPROC) get_proc("glMultiTexCoord2hNV");
	gl3wMultiTexCoord2hvNV = (PFNGLMULTITEXCOORD2HVNVPROC) get_proc("glMultiTexCoord2hvNV");
	gl3wMultiTexCoord3hNV = (PFNGLMULTITEXCOORD3HNVPROC) get_proc("glMultiTexCoord3hNV");
	gl3wMultiTexCoord3hvNV = (PFNGLMULTITEXCOORD3HVNVPROC) get_proc("glMultiTexCoord3hvNV");
	gl3wMultiTexCoord4hNV = (PFNGLMULTITEXCOORD4HNVPROC) get_proc("glMultiTexCoord4hNV");
	gl3wMultiTexCoord4hvNV = (PFNGLMULTITEXCOORD4HVNVPROC) get_proc("glMultiTexCoord4hvNV");
	gl3wFogCoordhNV = (PFNGLFOGCOORDHNVPROC) get_proc("glFogCoordhNV");
	gl3wFogCoordhvNV = (PFNGLFOGCOORDHVNVPROC) get_proc("glFogCoordhvNV");
	gl3wSecondaryColor3hNV = (PFNGLSECONDARYCOLOR3HNVPROC) get_proc("glSecondaryColor3hNV");
	gl3wSecondaryColor3hvNV = (PFNGLSECONDARYCOLOR3HVNVPROC) get_proc("glSecondaryColor3hvNV");
	gl3wVertexWeighthNV = (PFNGLVERTEXWEIGHTHNVPROC) get_proc("glVertexWeighthNV");
	gl3wVertexWeighthvNV = (PFNGLVERTEXWEIGHTHVNVPROC) get_proc("glVertexWeighthvNV");
	gl3wVertexAttrib1hNV = (PFNGLVERTEXATTRIB1HNVPROC) get_proc("glVertexAttrib1hNV");
	gl3wVertexAttrib1hvNV = (PFNGLVERTEXATTRIB1HVNVPROC) get_proc("glVertexAttrib1hvNV");
	gl3wVertexAttrib2hNV = (PFNGLVERTEXATTRIB2HNVPROC) get_proc("glVertexAttrib2hNV");
	gl3wVertexAttrib2hvNV = (PFNGLVERTEXATTRIB2HVNVPROC) get_proc("glVertexAttrib2hvNV");
	gl3wVertexAttrib3hNV = (PFNGLVERTEXATTRIB3HNVPROC) get_proc("glVertexAttrib3hNV");
	gl3wVertexAttrib3hvNV = (PFNGLVERTEXATTRIB3HVNVPROC) get_proc("glVertexAttrib3hvNV");
	gl3wVertexAttrib4hNV = (PFNGLVERTEXATTRIB4HNVPROC) get_proc("glVertexAttrib4hNV");
	gl3wVertexAttrib4hvNV = (PFNGLVERTEXATTRIB4HVNVPROC) get_proc("glVertexAttrib4hvNV");
	gl3wVertexAttribs1hvNV = (PFNGLVERTEXATTRIBS1HVNVPROC) get_proc("glVertexAttribs1hvNV");
	gl3wVertexAttribs2hvNV = (PFNGLVERTEXATTRIBS2HVNVPROC) get_proc("glVertexAttribs2hvNV");
	gl3wVertexAttribs3hvNV = (PFNGLVERTEXATTRIBS3HVNVPROC) get_proc("glVertexAttribs3hvNV");
	gl3wVertexAttribs4hvNV = (PFNGLVERTEXATTRIBS4HVNVPROC) get_proc("glVertexAttribs4hvNV");
	gl3wGenOcclusionQueriesNV = (PFNGLGENOCCLUSIONQUERIESNVPROC) get_proc("glGenOcclusionQueriesNV");
	gl3wDeleteOcclusionQueriesNV = (PFNGLDELETEOCCLUSIONQUERIESNVPROC) get_proc("glDeleteOcclusionQueriesNV");
	gl3wIsOcclusionQueryNV = (PFNGLISOCCLUSIONQUERYNVPROC) get_proc("glIsOcclusionQueryNV");
	gl3wBeginOcclusionQueryNV = (PFNGLBEGINOCCLUSIONQUERYNVPROC) get_proc("glBeginOcclusionQueryNV");
	gl3wEndOcclusionQueryNV = (PFNGLENDOCCLUSIONQUERYNVPROC) get_proc("glEndOcclusionQueryNV");
	gl3wGetOcclusionQueryivNV = (PFNGLGETOCCLUSIONQUERYIVNVPROC) get_proc("glGetOcclusionQueryivNV");
	gl3wGetOcclusionQueryuivNV = (PFNGLGETOCCLUSIONQUERYUIVNVPROC) get_proc("glGetOcclusionQueryuivNV");
	gl3wProgramBufferParametersfvNV = (PFNGLPROGRAMBUFFERPARAMETERSFVNVPROC) get_proc("glProgramBufferParametersfvNV");
	gl3wProgramBufferParametersIivNV = (PFNGLPROGRAMBUFFERPARAMETERSIIVNVPROC) get_proc("glProgramBufferParametersIivNV");
	gl3wProgramBufferParametersIuivNV = (PFNGLPROGRAMBUFFERPARAMETERSIUIVNVPROC) get_proc("glProgramBufferParametersIuivNV");
	...
	gl3wPathColorGenNV = (PFNGLPATHCOLORGENNVPROC) get_proc("glPathColorGenNV");
	gl3wPathTexGenNV = (PFNGLPATHTEXGENNVPROC) get_proc("glPathTexGenNV");
	gl3wPathFogGenNV = (PFNGLPATHFOGGENNVPROC) get_proc("glPathFogGenNV");
	...
	gl3wGetPathColorGenivNV = (PFNGLGETPATHCOLORGENIVNVPROC) get_proc("glGetPathColorGenivNV");
	gl3wGetPathColorGenfvNV = (PFNGLGETPATHCOLORGENFVNVPROC) get_proc("glGetPathColorGenfvNV");
	gl3wGetPathTexGenivNV = (PFNGLGETPATHTEXGENIVNVPROC) get_proc("glGetPathTexGenivNV");
	gl3wGetPathTexGenfvNV = (PFNGLGETPATHTEXGENFVNVPROC) get_proc("glGetPathTexGenfvNV");
	...
	gl3wPixelDataRangeNV = (PFNGLPIXELDATARANGENVPROC) get_proc("glPixelDataRangeNV");
	gl3wFlushPixelDataRangeNV = (PFNGLFLUSHPIXELDATARANGENVPROC) get_proc("glFlushPixelDataRangeNV");
	gl3wPointParameteriNV = (PFNGLPOINTPARAMETERINVPROC) get_proc("glPointParameteriNV");
	gl3wPointParameterivNV = (PFNGLPOINTPARAMETERIVNVPROC) get_proc("glPointParameterivNV");
	gl3wPresentFrameKeyedNV = (PFNGLPRESENTFRAMEKEYEDNVPROC) get_proc("glPresentFrameKeyedNV");
	gl3wPresentFrameDualFillNV = (PFNGLPRESENTFRAMEDUALFILLNVPROC) get_proc("glPresentFrameDualFillNV");
	gl3wGetVideoivNV = (PFNGLGETVIDEOIVNVPROC) get_proc("glGetVideoivNV");
	gl3wGetVideouivNV = (PFNGLGETVIDEOUIVNVPROC) get_proc("glGetVideouivNV");
	gl3wGetVideoi64vNV = (PFNGLGETVIDEOI64VNVPROC) get_proc("glGetVideoi64vNV");
	gl3wGetVideoui64vNV = (PFNGLGETVIDEOUI64VNVPROC) get_proc("glGetVideoui64vNV");
	gl3wPrimitiveRestartNV = (PFNGLPRIMITIVERESTARTNVPROC) get_proc("glPrimitiveRestartNV");
	gl3wPrimitiveRestartIndexNV = (PFNGLPRIMITIVERESTARTINDEXNVPROC) get_proc("glPrimitiveRestartIndexNV");
	gl3wCombinerParameterfvNV = (PFNGLCOMBINERPARAMETERFVNVPROC) get_proc("glCombinerParameterfvNV");
	gl3wCombinerParameterfNV = (PFNGLCOMBINERPARAMETERFNVPROC) get_proc("glCombinerParameterfNV");
	gl3wCombinerParameterivNV = (PFNGLCOMBINERPARAMETERIVNVPROC) get_proc("glCombinerParameterivNV");
	gl3wCombinerParameteriNV = (PFNGLCOMBINERPARAMETERINVPROC) get_proc("glCombinerParameteriNV");
	gl3wCombinerInputNV = (PFNGLCOMBINERINPUTNVPROC) get_proc("glCombinerInputNV");
	gl3wCombinerOutputNV = (PFNGLCOMBINEROUTPUTNVPROC) get_proc("glCombinerOutputNV");
	gl3wFinalCombinerInputNV = (PFNGLFINALCOMBINERINPUTNVPROC) get_proc("glFinalCombinerInputNV");
	gl3wGetCombinerInputParameterfvNV = (PFNGLGETCOMBINERINPUTPARAMETERFVNVPROC) get_proc("glGetCombinerInputParameterfvNV");
	gl3wGetCombinerInputParameterivNV = (PFNGLGETCOMBINERINPUTPARAMETERIVNVPROC) get_proc("glGetCombinerInputParameterivNV");
	gl3wGetCombinerOutputParameterfvNV = (PFNGLGETCOMBINEROUTPUTPARAMETERFVNVPROC) get_proc("glGetCombinerOutputParameterfvNV");
	gl3wGetCombinerOutputParameterivNV = (PFNGLGETCOMBINEROUTPUTPARAMETERIVNVPROC) get_proc("glGetCombinerOutputParameterivNV");
	gl3wGetFinalCombinerInputParameterfvNV = (PFNGLGETFINALCOMBINERINPUTPARAMETERFVNVPROC) get_proc("glGetFinalCombinerInputParameterfvNV");
	gl3wGetFinalCombinerInputParameterivNV = (PFNGLGETFINALCOMBINERINPUTPARAMETERIVNVPROC) get_proc("glGetFinalCombinerInputParameterivNV");
	gl3wCombinerStageParameterfvNV = (PFNGLCOMBINERSTAGEPARAMETERFVNVPROC) get_proc("glCombinerStageParameterfvNV");
	gl3wGetCombinerStageParameterfvNV = (PFNGLGETCOMBINERSTAGEPARAMETERFVNVPROC) get_proc("glGetCombinerStageParameterfvNV");
	...
	gl3wTexImage2DMultisampleCoverageNV = (PFNGLTEXIMAGE2DMULTISAMPLECOVERAGENVPROC) get_proc("glTexImage2DMultisampleCoverageNV");
	gl3wTexImage3DMultisampleCoverageNV = (PFNGLTEXIMAGE3DMULTISAMPLECOVERAGENVPROC) get_proc("glTexImage3DMultisampleCoverageNV");
	gl3wTextureImage2DMultisampleNV = (PFNGLTEXTUREIMAGE2DMULTISAMPLENVPROC) get_proc("glTextureImage2DMultisampleNV");
	gl3wTextureImage3DMultisampleNV = (PFNGLTEXTUREIMAGE3DMULTISAMPLENVPROC) get_proc("glTextureImage3DMultisampleNV");
	gl3wTextureImage2DMultisampleCoverageNV = (PFNGLTEXTUREIMAGE2DMULTISAMPLECOVERAGENVPROC) get_proc("glTextureImage2DMultisampleCoverageNV");
	gl3wTextureImage3DMultisampleCoverageNV = (PFNGLTEXTUREIMAGE3DMULTISAMPLECOVERAGENVPROC) get_proc("glTextureImage3DMultisampleCoverageNV");
	gl3wBeginTransformFeedbackNV = (PFNGLBEGINTRANSFORMFEEDBACKNVPROC) get_proc("glBeginTransformFeedbackNV");
	gl3wEndTransformFeedbackNV = (PFNGLENDTRANSFORMFEEDBACKNVPROC) get_proc("glEndTransformFeedbackNV");
	gl3wTransformFeedbackAttribsNV = (PFNGLTRANSFORMFEEDBACKATTRIBSNVPROC) get_proc("glTransformFeedbackAttribsNV");
	gl3wBindBufferRangeNV = (PFNGLBINDBUFFERRANGENVPROC) get_proc("glBindBufferRangeNV");
	gl3wBindBufferOffsetNV = (PFNGLBINDBUFFEROFFSETNVPROC) get_proc("glBindBufferOffsetNV");
	gl3wBindBufferBaseNV = (PFNGLBINDBUFFERBASENVPROC) get_proc("glBindBufferBaseNV");
	gl3wTransformFeedbackVaryingsNV = (PFNGLTRANSFORMFEEDBACKVARYINGSNVPROC) get_proc("glTransformFeedbackVaryingsNV");
	gl3wActiveVaryingNV = (PFNGLACTIVEVARYINGNVPROC) get_proc("glActiveVaryingNV");
	gl3wGetVaryingLocationNV = (PFNGLGETVARYINGLOCATIONNVPROC) get_proc("glGetVaryingLocationNV");
	gl3wGetActiveVaryingNV = (PFNGLGETACTIVEVARYINGNVPROC) get_proc("glGetActiveVaryingNV");
	gl3wGetTransformFeedbackVaryingNV = (PFNGLGETTRANSFORMFEEDBACKVARYINGNVPROC) get_proc("glGetTransformFeedbackVaryingNV");
	gl3wTransformFeedbackStreamAttribsNV = (PFNGLTRANSFORMFEEDBACKSTREAMATTRIBSNVPROC) get_proc("glTransformFeedbackStreamAttribsNV");
	gl3wBindTransformFeedbackNV = (PFNGLBINDTRANSFORMFEEDBACKNVPROC) get_proc("glBindTransformFeedbackNV");
	gl3wDeleteTransformFeedbacksNV = (PFNGLDELETETRANSFORMFEEDBACKSNVPROC) get_proc("glDeleteTransformFeedbacksNV");
	gl3wGenTransformFeedbacksNV = (PFNGLGENTRANSFORMFEEDBACKSNVPROC) get_proc("glGenTransformFeedbacksNV");
	gl3wIsTransformFeedbackNV = (PFNGLISTRANSFORMFEEDBACKNVPROC) get_proc("glIsTransformFeedbackNV");
	gl3wPauseTransformFeedbackNV = (PFNGLPAUSETRANSFORMFEEDBACKNVPROC) get_proc("glPauseTransformFeedbackNV");
	gl3wResumeTransformFeedbackNV = (PFNGLRESUMETRANSFORMFEEDBACKNVPROC) get_proc("glResumeTransformFeedbackNV");
	gl3wDrawTransformFeedbackNV = (PFNGLDRAWTRANSFORMFEEDBACKNVPROC) get_proc("glDrawTransformFeedbackNV");
	gl3wVDPAUInitNV = (PFNGLVDPAUINITNVPROC) get_proc("glVDPAUInitNV");
	gl3wVDPAUFiniNV = (PFNGLVDPAUFININVPROC) get_proc("glVDPAUFiniNV");
	gl3wVDPAURegisterVideoSurfaceNV = (PFNGLVDPAUREGISTERVIDEOSURFACENVPROC) get_proc("glVDPAURegisterVideoSurfaceNV");
	gl3wVDPAURegisterOutputSurfaceNV = (PFNGLVDPAUREGISTEROUTPUTSURFACENVPROC) get_proc("glVDPAURegisterOutputSurfaceNV");
	gl3wVDPAUIsSurfaceNV = (PFNGLVDPAUISSURFACENVPROC) get_proc("glVDPAUIsSurfaceNV");
	gl3wVDPAUUnregisterSurfaceNV = (PFNGLVDPAUUNREGISTERSURFACENVPROC) get_proc("glVDPAUUnregisterSurfaceNV");
	gl3wVDPAUGetSurfaceivNV = (PFNGLVDPAUGETSURFACEIVNVPROC) get_proc("glVDPAUGetSurfaceivNV");
	gl3wVDPAUSurfaceAccessNV = (PFNGLVDPAUSURFACEACCESSNVPROC) get_proc("glVDPAUSurfaceAccessNV");
	gl3wVDPAUMapSurfacesNV = (PFNGLVDPAUMAPSURFACESNVPROC) get_proc("glVDPAUMapSurfacesNV");
	gl3wVDPAUUnmapSurfacesNV = (PFNGLVDPAUUNMAPSURFACESNVPROC) get_proc("glVDPAUUnmapSurfacesNV");
	gl3wFlushVertexArrayRangeNV = (PFNGLFLUSHVERTEXARRAYRANGENVPROC) get_proc("glFlushVertexArrayRangeNV");
	gl3wVertexArrayRangeNV = (PFNGLVERTEXARRAYRANGENVPROC) get_proc("glVertexArrayRangeNV");
	...
	gl3wAreProgramsResidentNV = (PFNGLAREPROGRAMSRESIDENTNVPROC) get_proc("glAreProgramsResidentNV");
	gl3wBindProgramNV = (PFNGLBINDPROGRAMNVPROC) get_proc("glBindProgramNV");
	gl3wDeleteProgramsNV = (PFNGLDELETEPROGRAMSNVPROC) get_proc("glDeleteProgramsNV");
	gl3wExecuteProgramNV = (PFNGLEXECUTEPROGRAMNVPROC) get_proc("glExecuteProgramNV");
	gl3wGenProgramsNV = (PFNGLGENPROGRAMSNVPROC) get_proc("glGenProgramsNV");
	gl3wGetProgramParameterdvNV = (PFNGLGETPROGRAMPARAMETERDVNVPROC) get_proc("glGetProgramParameterdvNV");
	gl3wGetProgramParameterfvNV = (PFNGLGETPROGRAMPARAMETERFVNVPROC) get_proc("glGetProgramParameterfvNV");
	gl3wGetProgramivNV = (PFNGLGETPROGRAMIVNVPROC) get_proc("glGetProgramivNV");
	gl3wGetProgramStringNV = (PFNGLGETPROGRAMSTRINGNVPROC) get_proc("glGetProgramStringNV");
	gl3wGetTrackMatrixivNV = (PFNGLGETTRACKMATRIXIVNVPROC) get_proc("glGetTrackMatrixivNV");
	gl3wGetVertexAttribdvNV = (PFNGLGETVERTEXATTRIBDVNVPROC) get_proc("glGetVertexAttribdvNV");
	gl3wGetVertexAttribfvNV = (PFNGLGETVERTEXATTRIBFVNVPROC) get_proc("glGetVertexAttribfvNV");
	gl3wGetVertexAttribivNV = (PFNGLGETVERTEXATTRIBIVNVPROC) get_proc("glGetVertexAttribivNV");
	gl3wGetVertexAttribPointervNV = (PFNGLGETVERTEXATTRIBPOINTERVNVPROC) get_proc("glGetVertexAttribPointervNV");
	gl3wIsProgramNV = (PFNGLISPROGRAMNVPROC) get_proc("glIsProgramNV");
	gl3wLoadProgramNV = (PFNGLLOADPROGRAMNVPROC) get_proc("glLoadProgramNV");
	gl3wProgramParameter4dNV = (PFNGLPROGRAMPARAMETER4DNVPROC) get_proc("glProgramParameter4dNV");
	gl3wProgramParameter4dvNV = (PFNGLPROGRAMPARAMETER4DVNVPROC) get_proc("glProgramParameter4dvNV");
	gl3wProgramParameter4fNV = (PFNGLPROGRAMPARAMETER4FNVPROC) get_proc("glProgramParameter4fNV");
	gl3wProgramParameter4fvNV = (PFNGLPROGRAMPARAMETER4FVNVPROC) get_proc("glProgramParameter4fvNV");
	gl3wProgramParameters4dvNV = (PFNGLPROGRAMPARAMETERS4DVNVPROC) get_proc("glProgramParameters4dvNV");
	gl3wProgramParameters4fvNV = (PFNGLPROGRAMPARAMETERS4FVNVPROC) get_proc("glProgramParameters4fvNV");
	gl3wRequestResidentProgramsNV = (PFNGLREQUESTRESIDENTPROGRAMSNVPROC) get_proc("glRequestResidentProgramsNV");
	gl3wTrackMatrixNV = (PFNGLTRACKMATRIXNVPROC) get_proc("glTrackMatrixNV");
	gl3wVertexAttribPointerNV = (PFNGLVERTEXATTRIBPOINTERNVPROC) get_proc("glVertexAttribPointerNV");
	gl3wVertexAttrib1dNV = (PFNGLVERTEXATTRIB1DNVPROC) get_proc("glVertexAttrib1dNV");
	gl3wVertexAttrib1dvNV = (PFNGLVERTEXATTRIB1DVNVPROC) get_proc("glVertexAttrib1dvNV");
	gl3wVertexAttrib1fNV = (PFNGLVERTEXATTRIB1FNVPROC) get_proc("glVertexAttrib1fNV");
	gl3wVertexAttrib1fvNV = (PFNGLVERTEXATTRIB1FVNVPROC) get_proc("glVertexAttrib1fvNV");
	gl3wVertexAttrib1sNV = (PFNGLVERTEXATTRIB1SNVPROC) get_proc("glVertexAttrib1sNV");
	gl3wVertexAttrib1svNV = (PFNGLVERTEXATTRIB1SVNVPROC) get_proc("glVertexAttrib1svNV");
	gl3wVertexAttrib2dNV = (PFNGLVERTEXATTRIB2DNVPROC) get_proc("glVertexAttrib2dNV");
	gl3wVertexAttrib2dvNV = (PFNGLVERTEXATTRIB2DVNVPROC) get_proc("glVertexAttrib2dvNV");
	gl3wVertexAttrib2fNV = (PFNGLVERTEXATTRIB2FNVPROC) get_proc("glVertexAttrib2fNV");
	gl3wVertexAttrib2fvNV = (PFNGLVERTEXATTRIB2FVNVPROC) get_proc("glVertexAttrib2fvNV");
	gl3wVertexAttrib2sNV = (PFNGLVERTEXATTRIB2SNVPROC) get_proc("glVertexAttrib2sNV");
	gl3wVertexAttrib2svNV = (PFNGLVERTEXATTRIB2SVNVPROC) get_proc("glVertexAttrib2svNV");
	gl3wVertexAttrib3dNV = (PFNGLVERTEXATTRIB3DNVPROC) get_proc("glVertexAttrib3dNV");
	gl3wVertexAttrib3dvNV = (PFNGLVERTEXATTRIB3DVNVPROC) get_proc("glVertexAttrib3dvNV");
	gl3wVertexAttrib3fNV = (PFNGLVERTEXATTRIB3FNVPROC) get_proc("glVertexAttrib3fNV");
	gl3wVertexAttrib3fvNV = (PFNGLVERTEXATTRIB3FVNVPROC) get_proc("glVertexAttrib3fvNV");
	gl3wVertexAttrib3sNV = (PFNGLVERTEXATTRIB3SNVPROC) get_proc("glVertexAttrib3sNV");
	gl3wVertexAttrib3svNV = (PFNGLVERTEXATTRIB3SVNVPROC) get_proc("glVertexAttrib3svNV");
	gl3wVertexAttrib4dNV = (PFNGLVERTEXATTRIB4DNVPROC) get_proc("glVertexAttrib4dNV");
	gl3wVertexAttrib4dvNV = (PFNGLVERTEXATTRIB4DVNVPROC) get_proc("glVertexAttrib4dvNV");
	gl3wVertexAttrib4fNV = (PFNGLVERTEXATTRIB4FNVPROC) get_proc("glVertexAttrib4fNV");
	gl3wVertexAttrib4fvNV = (PFNGLVERTEXATTRIB4FVNVPROC) get_proc("glVertexAttrib4fvNV");
	gl3wVertexAttrib4sNV = (PFNGLVERTEXATTRIB4SNVPROC) get_proc("glVertexAttrib4sNV");
	gl3wVertexAttrib4svNV = (PFNGLVERTEXATTRIB4SVNVPROC) get_proc("glVertexAttrib4svNV");
	gl3wVertexAttrib4ubNV = (PFNGLVERTEXATTRIB4UBNVPROC) get_proc("glVertexAttrib4ubNV");
	gl3wVertexAttrib4ubvNV = (PFNGLVERTEXATTRIB4UBVNVPROC) get_proc("glVertexAttrib4ubvNV");
	gl3wVertexAttribs1dvNV = (PFNGLVERTEXATTRIBS1DVNVPROC) get_proc("glVertexAttribs1dvNV");
	gl3wVertexAttribs1fvNV = (PFNGLVERTEXATTRIBS1FVNVPROC) get_proc("glVertexAttribs1fvNV");
	gl3wVertexAttribs1svNV = (PFNGLVERTEXATTRIBS1SVNVPROC) get_proc("glVertexAttribs1svNV");
	gl3wVertexAttribs2dvNV = (PFNGLVERTEXATTRIBS2DVNVPROC) get_proc("glVertexAttribs2dvNV");
	gl3wVertexAttribs2fvNV = (PFNGLVERTEXATTRIBS2FVNVPROC) get_proc("glVertexAttribs2fvNV");
	gl3wVertexAttribs2svNV = (PFNGLVERTEXATTRIBS2SVNVPROC) get_proc("glVertexAttribs2svNV");
	gl3wVertexAttribs3dvNV = (PFNGLVERTEXATTRIBS3DVNVPROC) get_proc("glVertexAttribs3dvNV");
	gl3wVertexAttribs3fvNV = (PFNGLVERTEXATTRIBS3FVNVPROC) get_proc("glVertexAttribs3fvNV");
	gl3wVertexAttribs3svNV = (PFNGLVERTEXATTRIBS3SVNVPROC) get_proc("glVertexAttribs3svNV");
	gl3wVertexAttribs4dvNV = (PFNGLVERTEXATTRIBS4DVNVPROC) get_proc("glVertexAttribs4dvNV");
	gl3wVertexAttribs4fvNV = (PFNGLVERTEXATTRIBS4FVNVPROC) get_proc("glVertexAttribs4fvNV");
	gl3wVertexAttribs4svNV = (PFNGLVERTEXATTRIBS4SVNVPROC) get_proc("glVertexAttribs4svNV");
	gl3wVertexAttribs4ubvNV = (PFNGLVERTEXATTRIBS4UBVNVPROC) get_proc("glVertexAttribs4ubvNV");
	gl3wVertexAttribI1iEXT = (PFNGLVERTEXATTRIBI1IEXTPROC) get_proc("glVertexAttribI1iEXT");
	gl3wVertexAttribI2iEXT = (PFNGLVERTEXATTRIBI2IEXTPROC) get_proc("glVertexAttribI2iEXT");
	gl3wVertexAttribI3iEXT = (PFNGLVERTEXATTRIBI3IEXTPROC) get_proc("glVertexAttribI3iEXT");
	gl3wVertexAttribI4iEXT = (PFNGLVERTEXATTRIBI4IEXTPROC) get_proc("glVertexAttribI4iEXT");
	gl3wVertexAttribI1uiEXT = (PFNGLVERTEXATTRIBI1UIEXTPROC) get_proc("glVertexAttribI1uiEXT");
	gl3wVertexAttribI2uiEXT = (PFNGLVERTEXATTRIBI2UIEXTPROC) get_proc("glVertexAttribI2uiEXT");
	gl3wVertexAttribI3uiEXT = (PFNGLVERTEXATTRIBI3UIEXTPROC) get_proc("glVertexAttribI3uiEXT");
	gl3wVertexAttribI4uiEXT = (PFNGLVERTEXATTRIBI4UIEXTPROC) get_proc("glVertexAttribI4uiEXT");
	gl3wVertexAttribI1ivEXT = (PFNGLVERTEXATTRIBI1IVEXTPROC) get_proc("glVertexAttribI1ivEXT");
	gl3wVertexAttribI2ivEXT = (PFNGLVERTEXATTRIBI2IVEXTPROC) get_proc("glVertexAttribI2ivEXT");
	gl3wVertexAttribI3ivEXT = (PFNGLVERTEXATTRIBI3IVEXTPROC) get_proc("glVertexAttribI3ivEXT");
	gl3wVertexAttribI4ivEXT = (PFNGLVERTEXATTRIBI4IVEXTPROC) get_proc("glVertexAttribI4ivEXT");
	gl3wVertexAttribI1uivEXT = (PFNGLVERTEXATTRIBI1UIVEXTPROC) get_proc("glVertexAttribI1uivEXT");
	gl3wVertexAttribI2uivEXT = (PFNGLVERTEXATTRIBI2UIVEXTPROC) get_proc("glVertexAttribI2uivEXT");
	gl3wVertexAttribI3uivEXT = (PFNGLVERTEXATTRIBI3UIVEXTPROC) get_proc("glVertexAttribI3uivEXT");
	gl3wVertexAttribI4uivEXT = (PFNGLVERTEXATTRIBI4UIVEXTPROC) get_proc("glVertexAttribI4uivEXT");
	gl3wVertexAttribI4bvEXT = (PFNGLVERTEXATTRIBI4BVEXTPROC) get_proc("glVertexAttribI4bvEXT");
	gl3wVertexAttribI4svEXT = (PFNGLVERTEXATTRIBI4SVEXTPROC) get_proc("glVertexAttribI4svEXT");
	gl3wVertexAttribI4ubvEXT = (PFNGLVERTEXATTRIBI4UBVEXTPROC) get_proc("glVertexAttribI4ubvEXT");
	gl3wVertexAttribI4usvEXT = (PFNGLVERTEXATTRIBI4USVEXTPROC) get_proc("glVertexAttribI4usvEXT");
	gl3wVertexAttribIPointerEXT = (PFNGLVERTEXATTRIBIPOINTEREXTPROC) get_proc("glVertexAttribIPointerEXT");
	gl3wGetVertexAttribIivEXT = (PFNGLGETVERTEXATTRIBIIVEXTPROC) get_proc("glGetVertexAttribIivEXT");
	gl3wGetVertexAttribIuivEXT = (PFNGLGETVERTEXATTRIBIUIVEXTPROC) get_proc("glGetVertexAttribIuivEXT");
	gl3wBeginVideoCaptureNV = (PFNGLBEGINVIDEOCAPTURENVPROC) get_proc("glBeginVideoCaptureNV");
	gl3wBindVideoCaptureStreamBufferNV = (PFNGLBINDVIDEOCAPTURESTREAMBUFFERNVPROC) get_proc("glBindVideoCaptureStreamBufferNV");
	gl3wBindVideoCaptureStreamTextureNV = (PFNGLBINDVIDEOCAPTURESTREAMTEXTURENVPROC) get_proc("glBindVideoCaptureStreamTextureNV");
	gl3wEndVideoCaptureNV = (PFNGLENDVIDEOCAPTURENVPROC) get_proc("glEndVideoCaptureNV");
	gl3wGetVideoCaptureivNV = (PFNGLGETVIDEOCAPTUREIVNVPROC) get_proc("glGetVideoCaptureivNV");
	gl3wGetVideoCaptureStreamivNV = (PFNGLGETVIDEOCAPTURESTREAMIVNVPROC) get_proc("glGetVideoCaptureStreamivNV");
	gl3wGetVideoCaptureStreamfvNV = (PFNGLGETVIDEOCAPTURESTREAMFVNVPROC) get_proc("glGetVideoCaptureStreamfvNV");
	gl3wGetVideoCaptureStreamdvNV = (PFNGLGETVIDEOCAPTURESTREAMDVNVPROC) get_proc("glGetVideoCaptureStreamdvNV");
	gl3wVideoCaptureNV = (PFNGLVIDEOCAPTURENVPROC) get_proc("glVideoCaptureNV");
	gl3wVideoCaptureStreamParameterivNV = (PFNGLVIDEOCAPTURESTREAMPARAMETERIVNVPROC) get_proc("glVideoCaptureStreamParameterivNV");
	gl3wVideoCaptureStreamParameterfvNV = (PFNGLVIDEOCAPTURESTREAMPARAMETERFVNVPROC) get_proc("glVideoCaptureStreamParameterfvNV");
	gl3wVideoCaptureStreamParameterdvNV = (PFNGLVIDEOCAPTURESTREAMPARAMETERDVNVPROC) get_proc("glVideoCaptureStreamParameterdvNV");
}
