...
{
    {
        ...
        std::cout << "Testing: User Data setting and retrieval using helper methods with jag::draw::DrawNode. . ." << std::endl;
        {
            jag::draw::DrawNode udo;
            udo.setUserDataPair("prop1", 1);
            udo.setUserDataPair("prop2", 2);
            if(udo.getUserDataValue("prop2") != 2) {
                std::cerr << "could not retrieve previously set value from string key" << std::endl;
        ...
        std::cout << "Testing: User Data setting and retrieval using pass by reference get method with jag::draw::DrawNode. . ." << std::endl;
        {
            jag::draw::DrawNode udo;
            udo.getUserData()["prop1"] = "string test";
            udo.getUserData()["prop2"] = 42;
