...
#ifndef __JAG_DRAW_VERTEX_ATTRIB_H__
#define __JAG_DRAW_VERTEX_ATTRIB_H__ 1
...
/** \class VertexAttrib VertexAttrib.h <jag/draw/VertexAttrib.h>
\brief
...
public:
    ...
    virtual void execute( DrawInfo& drawInfo )
    {
        ...
        // TBD We must support the following use case. Imagine a jag::draw::DrawNode that sets a
        ...
        GLint index;
        if( drawInfo._current.contains( Command::Program_t ) )
        {
            ProgramPtr prog( boost::dynamic_pointer_cast< Program >( drawInfo._current[ Command::Program_t ] ) );
...
typedef jag::base::ptr< jag::draw::VertexAttrib >::shared_ptr VertexAttribPtr;
typedef std::vector< VertexAttribPtr > VertexAttribVec;


/** \class VertexAttribI VertexAttrib.h <jag/draw/VertexAttrib.h>
\brief
\details \gl{section 2.8}.
*/
...
typedef jag::base::ptr< jag::draw::VertexAttribI >::shared_ptr VertexAttribIPtr;
