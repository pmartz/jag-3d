...
#ifndef __JAG_DRAW_DRAW_NODE_H__
#define __JAG_DRAW_DRAW_NODE_H__ 1
...
/** \class DrawNode DrawNode.h <jag/draw/DrawNode.h>
...
public:
    ...
    \details Executes the contents of the jag::draw::DrawNode.
...
typedef jag::base::ptr< jag::draw::DrawNode >::shared_ptr DrawNodePtr;
