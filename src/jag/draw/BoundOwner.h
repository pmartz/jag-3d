...
#ifndef __JAG_DRAW_BOUND_OWNER_H__
#define __JAG_DRAW_BOUND_OWNER_H__ 1
...
\li Storage for (or a pointer to) a bounding volume (jag::draw::Bound).
...
VertexArrayObject, which jag::draw::Drawables iterate over to
...
public:
    ...
    */
    ...
    \specFuncEnd
    */
    virtual const BoundPtr& getBound( const jag::draw::CommandMap& commands )
    {
    ...
    \specFuncEnd
    */
    virtual void computeBound( BoundPtr& bound, const jag::draw::CommandMap& commands ) = 0;
    ...
    */
    ...
    /** \struct ComputeBoundCallback BoundOwner.h <jag/draw/BoundOwner.h>
    ...
    struct ComputeBoundCallback {
        ...
        \specFuncEnd
        */
        virtual void operator()( BoundPtr& _bound, const jag::draw::CommandMap& commands, BoundOwner* owner ) = 0;
    };
