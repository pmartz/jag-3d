...
#ifndef __JAG_DRAW_TRANSFORM_CALLBACK_H__
#define __JAG_DRAW_TRANSFORM_CALLBACK_H__ 1
...
the jag::draw::DrawNode Callback list to be executed at draw time. This same TransformCallback
...
jag::draw::DrawNode. This callback takes the stored projection and view matrices, as
well as the jag::draw::DrawNode's transform (the model matrix), concatenates them
...
\li The CollectionVisitor needs to be smarter about which jag::draw::DrawNode objects
...
is stupid, and sets the TransformCallback on all jag::draw::DrawNode objects.
...
\details TBD */
class JAGDRAW_EXPORT TransformCallback : public jag::draw::DrawNode::Callback
{
public:
    TransformCallback();
    ...
    virtual bool operator()( jag::draw::DrawNode& node, jag::draw::DrawInfo& drawInfo );
...
typedef jag::base::ptr< jag::draw::TransformCallback >::shared_ptr TransformCallbackPtr;
...
// __JAG_DRAW_TRANSFORM_CALLBACK_H__
#endif
