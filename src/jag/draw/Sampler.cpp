...
void Sampler::executeSampler( const jag::draw::jagDrawContextID contextID, const GLuint unit )
{
...
GLuint Sampler::getID( const jag::draw::jagDrawContextID contextID )
{
    if( _ids[ contextID ] == 0 )
    {
#ifdef GL_VERSION_3_3
...
void Sampler::deleteID( const jag::draw::jagDrawContextID contextID )
{
}
